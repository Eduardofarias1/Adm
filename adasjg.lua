...
local library = loadstring(game:HttpGet('https://github.com/Eduardofarias1/Test/blob/main/test.lua', true))()
...
local autoFarm, questByLevel, killingLabel = false, false
farmSection:Check({
    Text = "Enabled",
    Callback = function(v)
        autoFarm = v
            ...
            if player.Character and player.Character:FindFirstChild("HumanoidRootPart") and player.Character:FindFirstChild("Humanoid") and player.Character.Humanoid.Health > 0 then
                ...
                if nearestMob and questStatus() == "Ongoing" then
                    while true do
                        ...
                        player.Character.HumanoidRootPart.CFrame =  nearestMob.HumanoidRootPart.CFrame * CFrame.new(0, 6, 0) * CFrame.Angles(math.rad(-90), 0, 0)
